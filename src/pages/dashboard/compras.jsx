...
export function Compras() {
  ...
  const fetchCompras = async () => {
    try {
      const response = await axios.get("http://localhost:3005/api/compras");
  ...
  const fetchProveedores = async () => {
    try {
      const response = await axios.get("http://:3005/api/proveedores");
  ...
  const fetchInsumos = async () => {
    try {
      const response = await axios.get("http://:3005/api/insumos");
  ...
  const handleCancelCompra = async () => {
    ...
    try {
      ...
      await axios.patch(`http://:3005/api/compras/${compraToCancel}/estado`, { 
        id_estado: 5, 
