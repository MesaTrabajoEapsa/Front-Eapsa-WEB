...
export function Ventas() {
  ...
  const handleEntregarVenta = async (numero_venta) => {
    ...
    try {
      const response = await axios.patch(`http://localhost:3005/api/ventas/${numero_venta}/entregar`);
  ...
  const handleCancelVenta = async () => {
    ...
    try {
      await axios.patch(`http://localhost:3005/api/ventas/${ventaToCancel}/estado`, { 
