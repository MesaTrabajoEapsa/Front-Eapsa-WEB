...
export function Pedidos() {
  ...
  const handleUpdateEstado = async () => {
    try {
      const response = await axios.put(`http://localhost:3005/api/pedidos/${selectedPedido.numero_pedido}/estado`, { estado: selectedEstado });
  ...
  const handleCancelPedido = async () => {
    ...
    try {
      await axios.patch(`http://localhost:3005/api/pedidos/${pedidoToCancel}/estado`, {
        id_estado: 5, // Anulado
